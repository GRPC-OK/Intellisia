    ...
    <div className="github-bg">
      ...
      <main className="main-container-flex" style={{ position: 'relative' }}>
        <div className="main-content-left">
          <h1 className="main-title">Code Static Analysis Results</h1>
          <p className="main-subtitle">We found 2 security vulnerabilities in your code. We recommend you review and address them as soon as possible</p>
                  ...
                  <div className="vuln-content">
                    ...
                    <div className="vuln-details">
                      <div className="file-info">
                        <strong>{vuln.file}</strong>:<span className="line-number">{vuln.line}</span>
                      </div>
      ...
      <style jsx>{`
        ...
        .summary-item.minor .count {
          color: #f0e68c;
        }
        .summary-item.simple .count {
          color: #b0e0e6;
        }
        .summary-item .label {
          color: #8b949e;
