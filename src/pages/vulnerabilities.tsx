    ...
    <div className="github-bg">
      ...
      <main className="main-container-flex" style={{ position: 'relative' }}>
        <div className="main-content-left">
          <h1 className="main-title">Vulnerabilities found in your dependencies</h1>
          <p className="main-subtitle">We found 2 high severity vulnerabilities in your project. We recommend you review and address them as soon as possible</p>
          <section className="step-section">
            ...
            <div className="vuln-list">
              <div className="vuln-item">
                ...
                <div>
                  <div className="vuln-cve">CVE-2015-9251</div>
                  <div className="vuln-desc-detail">High severity, npm:lodash, 4.17.21</div>
                </div>
              </div>
              <div className="vuln-item">
                <span className="vuln-icon">🛡️</span>
            ...
            <button className="vuln-view-btn">View Details</button>
          </section>
        </div>
      </main>
      <style jsx>{`
